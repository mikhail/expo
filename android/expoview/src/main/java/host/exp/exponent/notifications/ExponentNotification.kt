    ...
    fun fromJSONObjectString(json: String?): ExponentNotification? {
      return if (json == null) {
        ...
        ExponentNotification(
          if (jsonObject.has(NotificationConstants.NOTIFICATION_EXPERIENCE_SCOPE_KEY_KEY)) jsonObject.optString(
            NotificationConstants.NOTIFICATION_EXPERIENCE_SCOPE_KEY_KEY
          ) else jsonObject.getString(NotificationConstants.NOTIFICATION_EXPERIENCE_ID_KEY),
          body,
