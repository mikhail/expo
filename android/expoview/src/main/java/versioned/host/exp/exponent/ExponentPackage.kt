...
class ExponentPackage : ReactPackage {
  ...
  companion object {
    ...
    private val sSingletonModules = mutableListOf<SingletonModule>()
    private val sSingletonModulesClasses = mutableSetOf<Class<*>>()
    ...
    fun getOrCreateSingletonModules(
      ...
      for (expoPackage in expoPackages) {
        ...
        for (singletonModule in packageSingletonModules) {
          if (!sSingletonModulesClasses.contains(singletonModule.javaClass)) {
            sSingletonModules.add(singletonModule)
            sSingletonModulesClasses.add(singletonModule.javaClass)
          }
        }
      }
